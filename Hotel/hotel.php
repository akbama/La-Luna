            ...
            <?php 
              ...
              <tr>
                ...
                <?php if(strtotime($today) > strtotime($row['Check_Out_Date'])){
                  ...
                  echo '<td><button style="background-color: #bb0a1e; color: white" class="button" type = "submit" id="tg-button">Checkout</button>';
                }else{
                  echo '<td class="tg-text7" style="color: black">' . $row['Check_Out_Date'] . '</td>';
                  echo '<td><button style="background-color: #FADA5E" class="button" type = "submit" id="tg-button">Checkout</button>';
                }?>
              </tr>
            </tbody>
            <?php }?>
