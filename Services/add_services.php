...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    if (is_null($r_type) == false) {
        ...
        $connect->query("INSERT INTO `hotel_services`(`Owners_ID`, `Room_Type`, `No_of_Nights`, `Extra_Guests1`, `Extra_Guests2`, `Hotel_Total`)
        VALUES('$owners_id','$r_type',$n_nights,$arr2[0],$arr2[1], $hoteltotal)") 
        or die($connect->error);
    }
